...
class TestJobCreation:
    ...
    def test_create_job(self, client: TestClient):
        ...
        response = client.post("/v1/picture/jobs", json={
...
class TestJobStatus:
    ...
    def test_get_job_status(self, client: TestClient):
        ...
        # Create a job first
        image_path = str(FIXTURES_DIR / "sample_document.png")
        create_resp = client.post("/v1/picture/jobs", json={
...
class TestJobRerun:
    ...
    def test_rerun_creates_new_job(self, client: TestClient):
        ...
        job = PictureJob(
            tenant_id="test",
            source=SourceSpec(uri=str(FIXTURES_DIR / "sample_document.png"), mime_type="image/png"),
            status=JobStatus.DONE,
        )
        repo.save_job(job)
