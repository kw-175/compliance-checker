...
class TestNaturalChain:
    ...
    def test_natural_explicit_image_dropped(
        ...
        assert any(finding.finding_type.value == "safety" for finding in result.findings)
